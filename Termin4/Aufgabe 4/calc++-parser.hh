...
#line 52 "calc++-parser.hh" // lalr1.cc:372
...
namespace yy {
#line 128 "calc++-parser.hh" // lalr1.cc:372
  ...
  basic_symbol (typename Base::kind_type t, const string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_ZAHL (const int& v, const location_type& l);

    static inline
    symbol_type
    make_SIGN (const char& v, const location_type& l);
  ...
  template <typename Base>
  calcxx_parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const string v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  calcxx_parser::symbol_type
  calcxx_parser::make_TEXT (const string& v, const location_type& l)
  {
    return symbol_type (token::TOK_TEXT, v, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_ZAHL (const int& v, const location_type& l)
  {
    return symbol_type (token::TOK_ZAHL, v, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_SIGN (const char& v, const location_type& l)
  {
    return symbol_type (token::TOK_SIGN, v, l);
  }

  calcxx_parser::symbol_type
  calcxx_parser::make_BLOCK (const string& v, const location_type& l)
  {
