...
#line 45 "calc++-parser.yy" // lalr1.cc:408
...
#line 323 "calc++-parser.cc" // lalr1.cc:617
        break;
...
#line 330 "calc++-parser.cc" // lalr1.cc:617
        break;
...
#line 67 "calc++-parser.yy" // lalr1.cc:617
        { yyoutput << yysym.value.template as< string > (); }
#line 337 "calc++-parser.cc" // lalr1.cc:617
        break;
...
#line 344 "calc++-parser.cc" // lalr1.cc:617
        break;
  ...
  calcxx_parser::parse ()
  {
    ...
    #line 36 "calc++-parser.yy" // lalr1.cc:725
{
  // Initialize the initial location.
  yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 466 "calc++-parser.cc" // lalr1.cc:725
...
#line 596 "calc++-parser.cc" // lalr1.cc:847
    break;
...
#line 610 "calc++-parser.cc" // lalr1.cc:847
    break;
...
#line 625 "calc++-parser.cc" // lalr1.cc:847
    break;
...
#line 116 "calc++-parser.yy" // lalr1.cc:847
    { //$$ = $1 - $3;
		  ...
		  yylhs.value.as< node* > () = new node(tmp, (node*)NULL);
		  yylhs.value.as< node* > ()->fval = yystack_[2].value.as< node* > ()->fval - yystack_[0].value.as< node* > ()->fval;
		  yylhs.value.as< node* > ()->label = "Value: " + driver.to_string(yylhs.value.as< node* > ()->fval);
		  cout << yystack_[2].value.as< node* > ()->fval << " - " << yystack_[0].value.as< node* > ()->fval << " = " << yylhs.value.as< node* > ()->fval << endl;
		}
#line 662 "calc++-parser.cc" // lalr1.cc:847
    break;
...
#line 688 "calc++-parser.cc" // lalr1.cc:847
  ...
  case 10:
#line 140 "calc++-parser.yy" // lalr1.cc:847
    { yylhs.value.as< node* > () = yystack_[1].value.as< node* > (); }
#line 694 "calc++-parser.cc" // lalr1.cc:847
    break;
...
#line 141 "calc++-parser.yy" // lalr1.cc:847
    { //$$ = driver.getVariable($1)
		    ...
		    yylhs.value.as< node* > ()->label = "Identifier: " + yystack_[0].value.as< string > () + " = " + driver.to_string(driver.variables[yystack_[0].value.as< string > ()]->fval);
                }
#line 707 "calc++-parser.cc" // lalr1.cc:847
    break;

  case 12:
#line 149 "calc++-parser.yy" // lalr1.cc:847
    { //swap ($$, $1); 
		  yylhs.value.as< node* > () = new node();
...
#line 718 "calc++-parser.cc" // lalr1.cc:847
    break;
...
#undef YYCASE_
  ...
  {
      -5,     7,     5,    -5,    10,     2,    -5,    -5,    -5,    19,
      -5,    -3,    10,    10,    10,    10,    10,    -5,    19,    21,
      21,    -5,    -5
  };
  ...
  {
       3,     0,     0,     1,     0,    11,    12,    13,     4,     2,
      11,     0,     0,     0,     0,     0,     0,    10,     5,     7,
       6,     8,     9
  };
  ...
  {
      11,    13,    14,    15,    16,    12,    17,     3,    18,    19,
      20,    21,    22,     4,     0,     5,     6,     7,     4,     0,
      10,     6,     7,    13,    14,    15,    16,    15,    16
  };

  const signed char
  calcxx_parser::yycheck_[] =
  {
       4,     4,     5,     6,     7,     3,     9,     0,    12,    13,
      14,    15,    16,     8,    -1,    10,    11,    12,     8,    -1,
      10,    11,    12,     4,     5,     6,     7,     6,     7
  };
  ...
  "\"*\"", "\"/\"", "\"(\"", "\")\"", "\"identifier\"", "\"number\"",
  "\"text\"", "$accept", "unit", "assignments", "assignment", "exp", YY_NULLPTR
  };
  ...
  {
       0,    71,    71,    77,    78,    83,    97,   116,   124,   132,
     140,   141,   149,   155
  };
...
#line 1108 "calc++-parser.cc" // lalr1.cc:1155
